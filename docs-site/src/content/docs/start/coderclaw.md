...
CoderClaw extends [CoderClaw](https://github.com/SeanHogg/coderClaw)'s multi-channel gateway (WhatsApp + Telegram + Discord + iMessage) with distributed runtime capabilities and enhanced security. This guide covers the "personal assistant" setup: one dedicated WhatsApp number that behaves like your always-on agent.
