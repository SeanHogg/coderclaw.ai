...
CoderClaw “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, CoderClaw can see that group and respond there.
