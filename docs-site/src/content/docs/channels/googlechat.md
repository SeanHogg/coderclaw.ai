...
2. Create a **Service Account**:
   ...
   - Name it whatever you want (e.g., `coderclaw-chat`).
...
5. Create a Google Chat app in the [Google Cloud Console Chat Configuration](https://console.cloud.google.com/apis/api/chat.googleapis.com/hangouts-chat):
   - Fill in the **Application info**:
     - **App name**: (e.g. `CoderClaw`)
     - **Avatar URL**: (e.g. `https://coderclaw.ai/logo.png`)
...
6. **Enable the app status**:
   ...
   - Click **Save** again.
7. Configure CoderClaw with the service account path + webhook audience:
...
2. CoderClaw verifies the token against the configured `audienceType` + `audience`:
