---
summary: "Context window + compaction: how CoderClaw keeps sessions under model limits"
read_when:
...
Before compaction, CoderClaw can run a **silent memory flush** turn to store
