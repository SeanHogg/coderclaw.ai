...
You can point CoderClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or CoderClaw
...
- [Anthropic provider](/providers/anthropic) - Native CoderClaw integration with Claude setup-token or API keys
