---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with CoderClaw"
read_when:
  - You want Xiaomi MiMo models in CoderClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). CoderClaw uses
