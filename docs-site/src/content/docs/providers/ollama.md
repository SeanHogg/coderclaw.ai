---
summary: "Run CoderClaw with Ollama (local LLM runtime)"
read_when:
  - You want to run CoderClaw with local models via Ollama
...
3. Enable Ollama for CoderClaw (any value works; Ollama doesn't require a real key):
