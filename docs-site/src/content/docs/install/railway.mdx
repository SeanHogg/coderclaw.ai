...
- `https://<your-railway-domain>/coderclaw` — Control UI
...
- `CODERCLAW_STATE_DIR=/data/.coderclaw` (recommended)
- `CODERCLAW_WORKSPACE_DIR=/data/workspace` (recommended)
- `CODERCLAW_GATEWAY_TOKEN` (recommended; treat as an admin secret)
