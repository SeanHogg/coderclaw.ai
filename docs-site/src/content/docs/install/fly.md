...
**Goal:** CoderClaw Gateway running on a [Fly.io](https://fly.io) machine with persistent storage, automatic HTTPS, and Discord/channel access.
...
Or visit `https://my-coderclaw.fly.dev/`
