---
summary: "CoderClaw macOS companion app (menu bar + gateway broker)"
read_when:
...
The macOS app is the **menu‑bar companion** for CoderClaw. It owns permissions,
