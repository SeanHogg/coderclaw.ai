---
title: "CoderClaw Partners with VirusTotal for Skill Security"
description: "CoderClawHub skills are now scanned by VirusTotal's threat intelligence platform—bringing industry-leading security to the AI coding assistant ecosystem."
date: 2026-02-07
authors:
  ...
  - name: "Bernardo Quintero"
    handle: "bquintero"
draft: false
tags: ["security", "announcement", "coderclawhub"]
image: "/blog/coderclaw-virustotal.svg"
---

Today we're announcing a partnership with [VirusTotal](https://www.virustotal.com), the world's leading threat intelligence platform, to bring security scanning to CoderClawHub—CoderClaw's skill marketplace.

**TL;DR:** All skills published to CoderClawHub are now scanned using VirusTotal's threat intelligence, including their new Code Insight capability. This provides an additional layer of security for the CoderClaw community.
...
CoderClaw skills are powerful. They extend what your AI assistant can do—from helping with code generation to automating development workflows to integrating with your development tools. But with that power comes risk.
...
As the CoderClaw ecosystem grows, so does the attack surface. We've already seen [documented cases](https://blog.virustotal.com/2026/02/from-automation-to-infection-how.html) of malicious actors attempting to exploit AI agent platforms. We're not waiting for this to become a bigger problem.

## How It Works

When a skill is published to CoderClawHub:
...
This partnership is part of a broader security initiative at CoderClaw. In the coming days, we'll be publishing:

- **A comprehensive threat model** for the CoderClaw ecosystem
...
Follow progress and read the full security program overview at [trust.coderclaw.ai](https://trust.coderclaw.ai/).
...
If you publish skills to CoderClawHub, your code will now be scanned automatically. Here's how it works:
...
We expect some false positives initially—security tooling isn't perfect. If your skill is incorrectly flagged, reach out to us at security@coderclaw.ai and we'll review it.

## For Users

When browsing CoderClawHub, you'll see scan status for each skill. This gives you one more data point when deciding what to trust. But remember:
...
- Report suspicious behavior to security@coderclaw.ai

## Thank You, VirusTotal

We're grateful to Bernardo Quintero and the VirusTotal team for their partnership. Their platform protects millions of users every day, and we're proud to bring that protection to the CoderClaw community.

## What's Next

This is the beginning, not the end. We're committed to making CoderClaw the most secure AI agent platform available. Expect more announcements soon.

The lobster grows stronger. 🦞

---

*Questions about security? security@coderclaw.ai*

*Publish skills: coderclawhub.ai*
